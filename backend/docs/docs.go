...
const docTemplate = `{
    ...
    "info": {
        ...
        "title": "{{.Title}}",
        "contact": {
            "name": "OS Baka Project",
            "url": "https://github.com/os-baka"
        },
        "license": {
            "name": "MIT"
        },
    ...
    "paths": {
        ...
        "/assets/boot": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Asset type (kernel, initrd, etc)",
                        "name": "type",
                        "in": "formData",
                        "required": true
                    },
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/model.BootAsset"
                        }
                    }
                }
            }
        ...
        "/audit-logs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by action prefix (e.g. node, user, dhcp)",
                        "name": "action",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.DHCPConfig"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/model.DHCPReservation"
                        }
                    }
                }
            }
        },
        "/dhcp/reservations/sync": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/model.NodeGroup"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.BulkIDsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nodes/bulk/group": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Node IDs and group ID",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/nodes/bulk/rebuild": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Node IDs to rebuild",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.PowerActionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/pxe/preseed/{mac}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Preseed configuration",
                        "schema": {
                            "type": "string"
                        }
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/sysutil.NetworkInterface"
                            }
                        }
                    }
                }
        ...
        "/ws/ssh": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "JWT token (optional, for browser clients that cannot set headers)",
                        "name": "token",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "api.CreateUserRequest": {
            ...
            "properties": {
                ...
                "role": {
                    "description": "admin, operator, auditor",
                    "type": "string"
                },
                "username": {
                    "type": "string"
        ...
        "api.PowerActionRequest": {
            ...
            "properties": {
                "action": {
                    "description": "on, off, reset, cycle, status",
                    "type": "string"
                }
            }
        },
        ...
        "model.BootAsset": {
            ...
            "properties": {
                ...
                "path": {
                    "description": "Relative path in tftpboot",
                    "type": "string"
                },
                "size": {
                    "type": "integer"
                ...
                "type": {
                    "description": "kernel, initrd, bootloader, other",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "model.DHCPConfig": {
            ...
            "properties": {
                ...
                "boot_server_ip": {
                    "description": "IP address for HTTP boot (API/Nginx)",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "is_active": {
                    "description": "Is this the active configuration",
                    "type": "boolean"
                },
                "kernel_params": {
                    "description": "Kernel parameters for PXE boot",
                    "type": "string"
                },
                "lease_time": {
                ...
                "mirror_url": {
                    "description": "OS mirror URL (e.g., http://archive.ubuntu.com/ubuntu)",
                    "type": "string"
                },
                "name": {
                ...
                "next_server": {
                    "description": "Next server IP (usually same as TFTP)",
                    "type": "string"
                },
                "range_end": {
        ...
        "model.DHCPReservation": {
            ...
            "properties": {
                ...
                "is_active": {
                    "description": "Is reservation active",
                    "type": "boolean"
                },
                "mac_address": {
